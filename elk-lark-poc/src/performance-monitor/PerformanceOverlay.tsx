...
import { performanceMonitor, PerformanceMetrics, ApiCallLog } from './performance-monitor';
import { sloMonitor, SLOSnapshot, SLOMetric } from './slo-monitor';
    ...
    return (
        <div style={styles.container}>
            ...
            <div style={styles.header}>
                <div>
                    <h3 style={styles.title}>⚡ ELK Lark · Performance Lab</h3>
                    {metrics?.appHealth && (
